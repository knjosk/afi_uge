c---------------------------------------------------------------------
c   SPME samle program - usage of the subroutine 'spme_prmt_sp'
...
c---------------------------------------------------------------------
      ...
      integer iorder,nfft1,nfft2,nfft3,nsp
...
c
      call spme_prmt_sp(numcgs,x,y,z,cg,flg_minimg,box,
     &               prec_req,cutoff_min,cutoff,ewaldcof,
     &               iorder,nfft1,nfft2,nfft3,nsp,
...
c
     ...
     &                       'resulted precisions are : '
      ...
      write(*,*)
      write(*,'(a,e10.4)')   'Avarage time for spme_all_sp = ', time
c
      stop
      end
c---------------------------------------------------------------------
...
c---------------------------------------------------------------------
c [MHa000@afivis *]$ ifort -openmp -save sample_spme_prmt_sp.f -lscs_mp -lifs
...
c examining: ewaldcof = 0.3945E+09
c  
c Best combination of parameters are : 
c   cutoff = 0.6386E-08
c ewaldcof = 0.6194E+09
c   iorder =    8
c    nfft1 =    9
c    nfft2 =    9
c    nfft3 =    9
...
c for FORCE_x :  -6.5019
c for FORCE_y :  -6.4561
c for FORCE_z :  -6.2218
c     for ENE :  -6.5297
c     for VIR :  -4.9349
c  
c Avarage time for spme_all_sp = 0.6721E-03
c 
c real    24m37.671s
c user    46m9.921s
c sys     0m5.309s
