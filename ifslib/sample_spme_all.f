c---------------------------------------------------------------------
c   SPME samle program - usage of the subroutine 'spme_all'
...
c---------------------------------------------------------------------
      implicit none
      integer numcgs,iorder,nfft1,nfft2,nfft3
      double precision cutoff,ewaldcof
      parameter(numcgs=6,
     &          cutoff=0.6368d-8,      ! [m]
     &          ewaldcof=0.6252d9,   ! [1/m]
     &          iorder=8,
...
c
c-----initialization
      call spme_init(numcgs,iorder,nfft1,nfft2,nfft3,bsp_mod,fftable)
c
      nstep = 0
 1000 nstep = nstep + 1
c
...
c-----calculation of Coulomb interaction
      call spme_all(numcgs,x,y,z,cg,flg_minimg,box,
...
c---------------------------------------------------------------------
c [MHa000@afivis *]$ ifort -openmp -save sample_spme_all.f -lscs_mp -lifs
