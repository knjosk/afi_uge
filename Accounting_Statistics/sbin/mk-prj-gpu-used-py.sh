...
USED_CURRENR_MONTH_FILE=${LOGS_DIR}/prj_gpu_used_pm.csv
FILE_PREFIX=prj_gpu_used_pm.
USED_PER_YEAR_FILE=${LOGS_DIR}/prj_gpu_used_py.csv
USED_TOTAL_EXCEPT_CURRENT_MONTH=${LOGS_DIR}/prj_gpu_used_total_except_current_month.csv
