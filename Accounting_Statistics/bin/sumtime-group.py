...
def parse():
    ...
    group_usage_file_name_base = "/opt/uge/Accounting_Statistics/logs/accounting/group_used_pm."
    group_usage_file_name = group_usage_file_name_base + month

    if args['<month>']:
        group_usage_file_name = group_usage_file_name_base + args['<month>']
